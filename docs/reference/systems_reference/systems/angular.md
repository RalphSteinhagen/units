...
|----------|:---------:|:---------:|:-------:|:-------:|:------:|----------|:---------:|
| <span id="angle"></span><code>angle</code> | Real | α | ✓ | <code>[angle](#angle)</code> | — | — | [view](../hierarchies/angle_angular.md) |
| <span id="solid_angle"></span><code>solid_<wbr>angle</code> | Real | α² | ✓ | <code>[solid_<wbr>angle](#solid_angle)</code> | — | <code>pow<2>([angle](#angle))</code> | [view](../hierarchies/solid_angle_angular.md) |
