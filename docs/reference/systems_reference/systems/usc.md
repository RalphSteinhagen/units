...
|-----------|:------:|:-----------:|------------|
| <span id="acre"></span><code>acre</code> | acre | `acre` | <code>mag<10> * <wbr>square([survey1893::chain](usc.md#survey1893-chain))</code> |
...
| <span id="furlong"></span><code>furlong</code> | fur | `fur` | <code>mag<10> * <wbr>[chain](#survey1893-chain)</code> |
...
| <span id="rankine"></span><code>rankine</code> | °R (\`R) | — | <code>mag_ratio<5, 9> * <wbr>[si::kelvin](si.md#kelvin), [si::absolute_<wbr>zero](si.md#absolute_zero)</code> |
...
| <span id="survey1893-league"></span><code>survey1893::league</code> | lea | — | <code>mag<3> * <wbr>[survey1893::us_<wbr>survey_<wbr>mile](usc.md#survey1893-us_survey_mile)</code> |
| <span id="survey1893-link"></span><code>survey1893::link</code> | li | — | <code>mag_ratio<33, 50> * <wbr>[survey1893::us_<wbr>survey_<wbr>foot](usc.md#survey1893-us_survey_foot)</code> |
| <span id="survey1893-rod"></span><code>survey1893::rod</code> | rd | — | <code>mag<25> * <wbr>[survey1893::link](usc.md#survey1893-link)</code> |
...
| <span id="survey1893-us_survey_mile"></span><code>survey1893::us_<wbr>survey_<wbr>mile</code> | mi(us) | — | <code>mag<8> * <wbr>[survey1893::furlong](usc.md#survey1893-furlong)</code> |
